                ...
                personaje ? (
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="card-text">Nombre: {personaje.nombre}.</p>
                            <p className="card-text">Nacionalidad: {personaje.nacionalidad }.</p>
                            <p className="card-text">Descripcion: {personaje.descripcion }.</p>
                            <p className="card-text"><img src={personaje.imagen }></img>.</p>
                        </div>
                    </div>
                ):
